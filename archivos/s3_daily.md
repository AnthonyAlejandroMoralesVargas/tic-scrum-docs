...
1.  **Bloqueos por Factores Externos Reincidentes:** Cortes de luz e inestabilidad de internet (Estefano y Emilio) afectaron el 40% de las Dailies.
2.  **Delegación Orgánica:** El equipo no espera al SM para delegar; Emilio asigna tareas a otros componentes proactivamente (Daily #9).
3.  **Deuda Técnica en Testing:** David tuvo que actualizar _todas_ las pruebas de los sprints pasados (Daily #9), lo que indica que las pruebas automatizadas no son resilientes a cambios en la UI.
